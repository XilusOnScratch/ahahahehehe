  ...
  const handleCompareClick = async () => {
    ...
    if (!profileToCompare?._id) {
      ...
      navigate('/results1', {
        state: {
          userName: name,
          otherName: profileToCompare?.name || "Naman Sonawane" // SHOULD BE Ahana Virmani
        }
      });
      return;
    }
    ...
    try {
      ...
      const response = await fetch('https://aha-backend-ph63.onrender.com/api/compare/compare', {
        method: 'POST',
        headers: {
